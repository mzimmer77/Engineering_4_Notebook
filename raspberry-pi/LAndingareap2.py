...
sda_pin = board.GP14 ##  SDA

scl_pin = board.GP15 ##  SCL

i2c = busio.I2C(scl_pin, sda_pin) ##  I2C pin

display_bus = displayio.I2CDisplay(i2c, device_address=0x3d, reset=board.GP13) #Connects the OLED to I2C hooukup
display = adafruit_displayio_ssd1306.SSD1306(display_bus, width=128, height=64) #Defines the  OLED

splash = displayio.Group() # creates a display group
display.show(splash)
